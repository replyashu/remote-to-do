...
package com.example.apple.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.apple.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/src/main/webapp/WEB-INF/Cloud To Do-2f0ffeef8a51.json"))
                .setDatabaseUrl("https://message-filter-42bb5.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@message-filter-42bb5.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("ashutoshsmartcool@gmail.com", "Recipient"));
